...
export default function CardContainer({ children, customStyles = "", group, hoverEffects }: Props) {
  return (
    <main
      className={cn(
        group && "group",
        "animate-fade-in-up bg-cream-light border-accent/15 relative cursor-default rounded-2xl border p-6 shadow-sm/5 shadow-stone-800 transition-all duration-250 ease-out",
